...
import { ArrowRightIcon, EyeIcon, Icon, RocketIcon, SparklesIcon, UsersIcon } from "lucide-react";
...
const LiveBadge = () => {
    ...
    <Badge 
        ...
        <span className="relative flex h-2 w-2">
            ...
            inline-flex h-full w-full rounded-full bg-primary opacity-75" />
    ...
    return(
        <section className = "relative overflow-hidden bg-linear-to-b from-background via background to-muted/20">
            ...
            <LiveBadge />
                ...
                leading-relaxed">
                    A community for creators to showcase their projects and get feedback from the community.
                </p>
                ...
                className="text-base px-8 shadow-lg">
                    <Link href ="/submit">
                    <SparklesIcon className="size-5" />Share your project </Link>
                    </Button>
                    <Button variant="secondary" asChild size ="lg"
                className="text-base px-8 shadow-lg">
                    <Link href ="/explore">Explore Projects 
